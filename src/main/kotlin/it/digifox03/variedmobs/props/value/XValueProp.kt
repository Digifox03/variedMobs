...
@Serializable
@SerialName("${VariedMobs.modId}:entity_x")
internal class XValueProp(override val entity: EntityProp? = null): EntityBasedProp<Float>(), ValueProp {
    override fun read(context: Map<Identifier, Any>): Float {
        val entity = getEntity(context)
        return entity.x.toFloat()
    }
}
